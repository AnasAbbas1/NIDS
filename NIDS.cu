...
__constant__ const int d = 2;
__constant__ const ull q = 65521;
__constant__ const int p = 1024;
__constant__ const ull n = 1 << 18;
__constant__ const ull m = 13;
__constant__ const ull mps[] = {7, 31, 127, 8191, 131071, 524287};
__constant__ const int masksz = 6;
__constant__ const ull masks[] = {7, 248, 32512, 268402688, 35184103653376ull, 18446708889337462784ull};
__constant__ const ull nmasks[] = {18446744073709551608ull, 18446744073709551367ull, 18446744073709519103ull, 18446744073441148927ull, 18446708889605898239ull, 35184372088831ull};
__constant__ const ull shifts[] = {3, 5, 7, 13, 17, 19};
__constant__ const ull cumShifts[] = {0, 3, 8, 15, 28, 45};
__constant__ const ull ds[] = {2, 3, 5, 11, 13, 17};
__constant__ const ull HTSZ = 1 << 18;
__constant__ const ull HTMSK = HTSZ - 1;
struct testcase {
private:
    string input_str;
